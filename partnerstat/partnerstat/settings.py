"""
Django settings for partnerstat project.
...
SECRET_KEY = 'ams9x101l*oxw*8_4@*k@v94!f9x+&@2d(73$dpqr@3$n-^#9u'
...
ROOT_URLCONF = 'partnerstat.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'partnerstat/templates/'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'partnerstat.wsgi.application'
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'pub/static/')
